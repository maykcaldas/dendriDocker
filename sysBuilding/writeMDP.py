...
def write_mdp_nvt(file_name, nsteps, dt, cont, temp):
    ...
    nvt.write('nstvout   		    = 0		    ; save velocities every 1.0 ps\n')
    nvt.write('nstenergy	        = 0		    ; save energies every 1.0 ps\n')
...
def write_mdp_npt(file_name, nsteps, dt, cont, temp, press):
    ...
    npt.write('nstvout		            = 500		; save velocities every 1.0 ps\n')
    npt.write('nstenergy	            = 500		; save energies every 1.0 ps\n')
...
def write_mdp_md(file_name, nsteps, dt, temp, press):
    ...
    md.write('nstvout		            = 0		; save velocities every 10.0 ps\n')
    md.write('nstenergy	                = 0		; save energies every 10.0 ps\n')
    md.write('nstlog		            = 500000		; update log file every 10.0 ps\n')
